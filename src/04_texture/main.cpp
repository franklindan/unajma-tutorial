...
int main()
{
    ...
    unsigned int VBO_Vertices, VB0_texture, VAO, EBO;
    glGenVertexArrays(1, &VAO);
    glGenBuffers(1, &VBO_Vertices);
    glGenBuffers(1, &VB0_texture);
    glGenBuffers(1, &EBO);
    ...
    glBindBuffer(GL_ARRAY_BUFFER, VB0_texture);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
    ...
    unsigned char *data = stbi_load( "asserts/wall.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
